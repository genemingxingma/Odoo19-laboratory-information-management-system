...
print('sudo_count_after_commit', sudo_count)
...
if u:
    ...
    print('visible_for_mingxingma_after_commit', visible)
    for r in partner_model.with_user(u).search(dom, limit=10):
        print(r.id, r.name, r.lab_physician_department_id.name if r.lab_physician_department_id else '-')
